(function (root, factory) {
    ...
    function augmenter(value, x, y) {
        ...
        if (!x) return {
            start: min(y.start, interval.start),
            end: max(y.end, interval.end)
        };

        if (!y) return {
            start: min(x.start, interval.start),
            end: max(x.end, interval.end)
        };

        return {
            start: min(min(x.start, y.start), interval.start),
            end: max(max(x.end, y.end), interval.end)
        };
    }
